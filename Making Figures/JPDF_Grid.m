...
%     figure;
%     imshow(ColorChangeWhite(USmean1,USmean2,.5));hold on;
%     for X=1:4
%         for Y=1:5
%             Xpt=PDFs(Y,X).Xpix;
%             Ypt=PDFs(Y,X).Ypix;
%             %Can Delete                Ypt=YDatUS(PDFptsUS(Y,i,2));
%           %  subaxis(2,1,1,'Spacing', 0.02, 'Padding', 0.000, 'Margin', .02);
%                 rectangle('Position',[(Xpt-Box(1)/2),Ypt-Box(2)/2,Box(1),Box(2)]);
%             Xpt=PDFsOLD(Y,X).Xpix;
%             Ypt=PDFsOLD(Y,X).Ypix;
%             %Can Delete                Ypt=YDatUS(PDFptsUS(Y,i,2));
%           %  subaxis(2,1,1,'Spacing', 0.02, 'Padding', 0.000, 'Margin', .02);
%                 rectangle('Position',[(Xpt-Box(1)/2),Ypt-Box(2)/2,Box(1),Box(2)],'EdgeColor','b');                
%           %  subaxis(2,1,2,'Spacing', 0.02, 'Padding', 0.000, 'Margin', .02);
%           %      rectangle('Position',[(Xpt-BoxN(1)/2),Ypt-BoxN(2)/2,BoxN(1),BoxN(2)]);
%        end
%     end
...
%                 imagesc(Xax,Yax, log(flipud(JPDF)));hold on;
